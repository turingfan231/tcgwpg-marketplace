    ...
    <div className="space-y-8">
      <section className="console-panel overflow-hidden p-0">
        <div className="relative overflow-hidden bg-[linear-gradient(135deg,#0f2536,#17384c)] p-7 text-white sm:p-8">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(255,255,255,0.08),transparent_18%),radial-gradient(circle_at_82%_20%,rgba(255,153,0,0.12),transparent_18%)]" />
