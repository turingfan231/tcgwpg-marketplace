            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-steel">
                  Open this when you want the exact card, image, and market info. Otherwise just post the listing normally.
                </p>
              </div>
            ...
            <section className="console-panel p-4 sm:p-5">
              <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 hidden max-w-2xl text-sm leading-7 text-steel sm:block">
